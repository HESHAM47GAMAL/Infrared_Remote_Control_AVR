...
#define MAX_NUM_COL_LCD         16

/*  Configure Max number of Rows Availale for LCD  */
#define MAX_NUM_ROW_LCD         2
...
/*  will use this part to tell start pin for 4 lines connection*/
    ...
    #define OPTION_PINS             NOT_Sequencial_PINS
        ...
        #define PIN_D4      PIN4_ID
        #define PIN_D5      PIN5_ID
        #define PIN_D6      PIN6_ID
        #define PIN_D7      PIN7_ID     
    #endif
...
#define ALWAYS_READ_LCD             0       //Here Won't configure it(if not exist) as always connected to ground
#define READ_WRITE_LCD              1       //Here will configure this pin to connect

#define OPTION_RW_PIN           READ_WRITE_LCD
